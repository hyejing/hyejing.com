<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
    <a class="sidebar-brand d-flex align-items-center pr-4 /*justify-content-center*/" href="/">
       <img src="/assets/images/logo_header.png" alt="">
        <!--  <span class="fs-5 px-3 text-light text-nowrap">{C.CNF_TITLE}</span> -->
    </a>
    ...
    <ul class="navbar-nav ml-auto ml-md-0">
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
                ...
                {/}
                <a class="dropdown-item" href="#" onclick="javascript: js_popup('/admin/mypage', 'admin_mypage', 600, 600);">내 정보</a>
                <div class="dropdown-divider"></div>
